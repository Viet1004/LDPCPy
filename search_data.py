...
with open("result_new.txt", 'r') as file:
...
#            print(line)
        ...
        if set_timing != None:
            ...
            if parameterList[-1] == ending_point[0]:
                ...
                listPro1 = [timeList[i*3] for i in range(5)]
                listPro2 = [timeList[i*3+1] for i in range(5)]
                listPro3 = [timeList[i*3+2] for i in range(5)]
                plt.figure(1)
                plt.plot(length, listPro1, label="w_c/w_r = 3/4, p = 0.02")
                plt.plot(length, listPro2, label="w_c/w_r = 3/4, p = 0.05")
                plt.plot(length, listPro3, label="w_c/w_r = 3/4, p = 0.1")
                plt.ylabel("Time (s)")
